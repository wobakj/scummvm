...
#define	SCNHANDLE_SHIFT ((TinselAboveV1 && !TinselAboveV1Demo) ? 25 : 23)
#define	OFFSETMASK ((TinselAboveV1 && !TinselAboveV1Demo) ? 0x01ffffffL : 0x007fffffL)
#define HANDLEMASK ((TinselAboveV1 && !TinselAboveV1Demo) ? 0xFE000000L : 0xFF800000L)
