...
#define ISV_NO_BLOCKING (TinselV3 ? ISV_NO_BLOCKING_T3 : ISV_NO_BLOCKING_T2)
#define ISV_GHOST_ACTOR (TinselV3 ? ISV_GHOST_ACTOR_T3 : ISV_GHOST_ACTOR_T2)
#define ISV_GHOST_BASE (TinselV3 ? ISV_GHOST_BASE_T3 : ISV_GHOST_BASE_T2)
#define ISV_GHOST_COLOR (TinselV3 ? ISV_GHOST_COLOR_T3 : ISV_GHOST_COLOR_T2)
